    ...
    if (username && password) {
        ...
        axios
            ...
            .then(function (response) {
                ...
                if (room) {
                    window.location.href = SERVER_BASE + '/join/' + window.location.search;
                    return;
                }
                // Redirect to room if specified in path
                if (roomPath && roomPath !== 'login') {
                    window.location.href = SERVER_BASE + '/join/' + roomPath;
                    return;
                }
                    ...
                    joinSelectRoomBtn.onclick = () => {
                        ...
                        if (roomName) {
                            ...
                            window.location.href =
                                SERVER_BASE + '/join/?room=' + roomName + '&token=' + window.sessionStorage.peer_token;
                        } else {
                ...
                window.location.href = room
                    ? SERVER_BASE + '/logged?room=' + room
                    : sessionRoom
                      ? SERVER_BASE + '/logged?room=' + sessionRoom
                      : SERVER_BASE + '/logged';
                return;
            })
...
function join() {
    ...
    window.location.href = SERVER_BASE + '/join/?room=' + roomId + '&token=' + window.sessionStorage.peer_token;
}
